...
from iris.coords import CellMethod, DimCoord, AuxCoord, Coord, AncillaryVariable
...
class Cube(CFVariableMixin):
    ...
    def is_compatible(self, other: Union[Cube, CubeMetadata], ignore: Optional[Any] = ...) -> bool: ...
